...
export default function ComparePlansPage() {
  ...
  const samePlan = planA && planB && planA.id === planB.id;
    ...
    <>
      ...
      >
        ...
        <p className="mt-3 max-w-2xl text-[var(--muted)] leading-relaxed">
          Pick two snapshots you saved from the roadmap. We line up your answers and show a quick
          read on how each plan would shape the generated roadmap.
        </p>
